...
import com.basic.manager.common.enums.BusinessStatus;
import com.basic.manager.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.basic.manager.common.annotation.Log)")
