...
import com.basic.manager.common.json.JSONObject;
import com.basic.manager.common.json.JSONObject.JSONArray;
...
public class DemoFormController
{
    ...
    {
        String[] array = { "basic.manager 1", "basic.manager 2", "basic.manager 3", "basic.manager 4", "basic.manager 5" };
        AjaxResult ajax = new AjaxResult();
